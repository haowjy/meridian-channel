...
def _run_create(
    ...
    agent: Annotated[str | None, Parameter(name=["--agent", "-a"])] = None,
    report_path: Annotated[str, Parameter(name="--report-path")] = "report.md",
    dry_run: Annotated[bool, Parameter(name="--dry-run")] = False,
    verbose: Annotated[bool, Parameter(name="--verbose")] = False,
    quiet: Annotated[bool, Parameter(name="--quiet")] = False,
    stream: Annotated[bool, Parameter(name="--stream")] = False,

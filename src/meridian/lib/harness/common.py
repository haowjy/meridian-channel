"""Shared helpers and strategy-driven command builder for harness adapters.

Merged from ``harness/_common.py`` (shared helpers) and
...
# ---------------------------------------------------------------------------
# Strategy-driven command builder (from _strategies.py)
# ---------------------------------------------------------------------------

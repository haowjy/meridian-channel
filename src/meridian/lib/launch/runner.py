    ...
    *,
    ...
    if spawn_row is None:
        spawn_store.start_spawn(
            ...
            agent_source=plan.agent_source,
            skills=plan.skills,
            skill_paths=plan.skill_paths,
            skill_sources=plan.skill_sources,
            bootstrap_required_items=plan.bootstrap_required_items,
            bootstrap_missing_items=plan.bootstrap_missing_items,

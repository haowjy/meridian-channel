...
Local tracking files (`decision-log.md`, `implementation-log.md` in `$MERIDIAN_WORK_DIR/`) are always the source of truth. GitHub Issues are a visibility layer — they give the team searchability, linkability, and a shared view of what was found during agent work.
